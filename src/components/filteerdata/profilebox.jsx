...
export const profileHome= [
    {
      ...
      },
      {
        ...
        +"The film centers around Dom Cobb, portrayed by Leonardo DiCaprio, a skilled thief who specializes in a unique form of espionage: entering people's dreams to extract valuable information. However, instead of stealing ideas, he is presented with an opportunity to perform 'inception' – the planting of an idea into the subconscious mind of a target."
